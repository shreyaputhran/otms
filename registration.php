...
if(isset($_POST['register']))
{
    ...
    $pwd= $_POST['pwd'];
    $conpwd=$_POST['conpwd'];
$query ="INSERT into 'user'(uname,add,gender,contact,email,pwd)
VALUES ('$uname','$add','$gender','$contact','$email','$pwd')";
                ...
                <div id="main-menu">
                    ...
                    <div class="list-group panel">
                        ...
                        <div class="collapse sub-menu" id="pages-links">
                            ...
                            <a href="#"  class="list-group-item active">Registration</a>
                        	...
                        	<div class="flex-content">
                                <div class="custom-form custom-form-fields">
                                    ...
                                    <form method="POST">
                                        ...
                                        <div class="form-group">
                                             <input type="password" name="conpwd"class="form-control" placeholder="Confirm Password"  required/>
                                             <span><i class="fa fa-lock"></i></span>
                                        </div>
                                        <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <button name="register" class="btn btn-orange btn-block" type="submit">Register</button>
                                    </form>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" id="copyright">
                            <p>© 2017 <a href="#">V2Travel</a>. All rights reserved.</p>
                        </div><!-- end columns -->
